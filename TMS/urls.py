...
from .views import TaskCreateView, TaskListView, TaskUpdateView, TaskDeleteView, TaskDetailView, task_list, UserCreateView, UserUpdateView, UserDeleteView, UserDetailView
